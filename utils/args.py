...
parser.add_argument('--overlap_ratio', type=float, default=0.2, help="Overlap ratio of epochs")
...
parser.add_argument('--classes', type=List[str], default=['F','C', 'A'], help='Classes to use in EEG problem')
